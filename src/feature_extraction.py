...
from src.data_importers import oxford_import as oi, gmobility_import as gi, jhu_import as di, state_info_import as si, who_import as wi
import pandas as pd
import warnings
import sys
import os
...
selected_measures = [
    ("school", "c1_school_closing"),
    ("public_transport", "c5_close_public_transport"),
...
if __name__ == "__main__":
    ...
    args = sys.argv
    out_full_path = config["common"]["paths"]["features"]
